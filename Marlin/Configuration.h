...
#define STRING_CONFIG_H_AUTHOR "(Andrei Golyakov, FBG5SKR14T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FBG 5/SKR 1.4 T"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 43, -50, -1.950 }
